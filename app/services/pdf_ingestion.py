...
class PDFTextExtractor:
    ...
    Handles text extraction from PDF files with proper error handling
    and text cleaning for legal document processing.
    """
    
    def __init__(self):
        self.max_text_length = 8000  # Maximum text length for processing
...
class TextChunker:
    ...
    Provides intelligent text chunking that preserves sentence boundaries
    and maintains context for legal document processing.
    """
...
class PDFIngestionService:
    ...
    Coordinates PDF text extraction, chunking, and storage in the
    legal research database with proper error handling.
    """
    ...
    def _prepare_documents_for_ingestion(
        ...
        """
        Prepare document data for ingestion into the knowledge base.
