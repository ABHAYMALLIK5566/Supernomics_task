...
- Include the exact legal source and article/section reference
- Use precise legal language
- Avoid lengthy explanations or background information
- Format: Definition + Citation""",
            max_tokens=200,
            temperature=0.1
        )
...
- Include specific legal citations for each item
- Use consistent formatting
- Maximum 8-10 items unless specifically requested otherwise
- Format: Numbered list with citations""",
            max_tokens=300,
            temperature=0.2
        )
...
- Format: Direct answer with citation""",
    ...
    def get_generation_parameters(self, intent: QueryIntent) -> Dict[str, Any]:
        """Get generation parameters for a specific intent."""
        template = self.get_template(intent)
        return {
